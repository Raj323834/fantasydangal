...
<!--                </div>-->
        ...
        <div class="yrm-accordion-content yrm-hide-content">
	        ...
	        <div class="row row-static-margin-bottom">
		        ...
		        <div class="col-xs-3">
			        <?php echo $functions::yrmSelectBox($params['arrowIconAlignment'], esc_attr($savedObj->getOptionValue('arrow-icon-alignment')), array('name'=>"arrow-icon-alignment", 'class'=>'yrm-js-select2', 'id'=>'arrow-icon-alignment'));?>
		        </div>
	        </div>
            <div class="row row-static-margin-bottom">
                <div class="col-xs-5">
